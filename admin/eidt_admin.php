...
<table class="all">
    ...
    <tr>
        ...
        <td class="pp"><input type="text" name="pw" id="pw" value='<?=$row['pw'];?>'></td>
    </tr>
    <tr>
        <td class="tt ct">權限</td>
        <td class="pp">
            <div><input type="checkbox" name="pr[]" value="1" <?=(in_array(1,$pr))?"checked":"";?>> 商品管理</div>
            ...
            <div><input type="checkbox" name="pr[]" value="5" <?=(in_array(5,$pr))?"checked":"";?>> 最新消息</div>
        </td>
    </tr>
</table>
